...
public:
        ...
        Game()
        {
                ...
                S.Init(status, 2, 13);
                SM.Init(playwin, RA(4, max_y), RA(4, max_x), 1, 0, max_x);
                SMA.Init(playwin, RA(6, max_y), RA(6, max_x), 1, 0, max_x);
                SMB.Init(playwin, RA(9, max_y), RA(9, max_x), 1, 0, max_x);
